    ...
    <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
      <section className="rounded-[2rem] border border-amber-400/20 bg-slate-950/70 p-8 shadow-2xl shadow-black/30">
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-slate-300">
          Il portale usa sessioni Supabase standard con email e password.
          L&apos;utente si registra con email, password, nome Steam e nome Discord,
          conferma l&apos;email e poi entra direttamente nella dashboard.
        </p>
